...
/** Root production. */
 ...
 HashMap<String,Integer> hash = new HashMap<String,Integer>();
  ...
  static public void changedReInit(java.io.InputStream stream) {
	     changedReInit(stream, null);
	  }
	  static public void changedReInit(java.io.InputStream stream, String encoding) {
		 // try { jj_input_stream = new SimpleCharStream(stream, encoding, 1, 1); } catch(java.io.UnsupportedEncodingException e) { throw new RuntimeException(e); }
		  jj_input_stream.buffer = null;
...
public static XYZParserTokenManager getToken_source() {
	return token_source;
}

public static void setToken_source(XYZParserTokenManager token_source) {
	XYZParser.token_source = token_source;
}
