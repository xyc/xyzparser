...
public class JSFileFilter extends FileFilter 
{
    ...
    /**
     * 构造函数
     *参数：filesExtsIn 允许的文件后缀。
     * 参数：description 对文件后缀的描述。
     */
    public JSFileFilter(String[] filesExtsIn, String description) 
    {
    ...
    /**
     * 如果后缀和 in 相同，则返回true；否则返回false。
     *参数： in 允许的后缀名。
     * 参数： 如果后缀和 in 相同，则返回true；否则返回false。
     */
